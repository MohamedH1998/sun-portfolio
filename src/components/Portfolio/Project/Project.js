...
const Project = ({ photo, cardTitle, cardText, liveDemo, sourceCode }) => {
  return (
    <>
      <div className="max-w-md bg-clr-bg-light-offset md:mx-4 my-4 rounded-lg border border-gray-200 dark:border-0 shadow-md dark:bg-clr-bg dark:shadow-clr-bg-lightest-offset dark:border-gray-700">
        <a href={liveDemo}>
