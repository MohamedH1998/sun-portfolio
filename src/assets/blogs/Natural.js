    ...
    <div>
      ...
      <section className="pb-6">
        <p className="pb-2">
          ...
          must be good, right? Examples of these include our unreasonable
        ...
        <p>
          ...
          advances like novel gene editing and implantable chips, the gravity of
          answering these questions cannot be understated. Levinovitz attempts
          to do exactly this in his book Natural: The Seductive Myth of
          Nature&#39;s Goodness.
        </p>
      </section>
      <section className="pb-6">
        <h5 className="">Nature/Natural in different traditions</h5>
        <p className="">
          ...
          translates to something like &#39;the spontaneous occurrences in the
          universe&#39;. The Taoists believed that the spontaneous
          transformations (aka natural events) of the universe are not the
          product of any assertive desire or action, and for humans to interfere
        ...
        <p className="pb-2">
          ...
          the ability to perceive the Oneness of God, and through adverse
          environmental influences and/or self-indulgence is this disposition
          influenced and contaminated.
        </p>
      </section>
      <section className="pb-6">
        <h5 className="">Problems with the term</h5>
        <p className="pb-2">
          ...
          natural analogies to provide support for our beliefs. The more
        ...
        <p className="pb-2">
          ...
          interchangeably with goodness is rife with contradictions. Befitting
          of a Professor of Religious Studies, he concludes that these terms are
          theological in nature (lool), whereby &#39;Nature&#39; is another term
          for God and &#39;natural&#39; is holy. Just as God&#39;s Commandments
        ...
        <p className="pb-2">
          ...
          is good&#39;, any lines that we draw seem somewhat arbitrary.
          Anti-vaxxers are depicted as uneducated idiots with no care for the
          world, in my opinion, they seem to be people who genuinely want the
          best for themselves and their children- depicting them as maniacs and
          strawmaning their arguments helps no one. What seems to be happening
          is no different than the disagreements between religious
          fundamentalists (anti-vaxxers) and religious liberals (vaxxers[??]).
        </p>
      </section>
      <section className="pb-6">
        <h5 className="">Natural Births</h5>
        <p className="pb-2">
          ...
          for epidurals or invasive care. Many refer to animals and make mention
        ...
        <p className="pb-2">
          ...
          UK in the early 18th century was as high as 1000 per 100,000 births
          and is now at 19 per 100,000 births (as of 2016), which can be largely
        ...
        <p className="pb-2">
          ...
          experience reduced pregnancy to a medical condition, described only in
          terms of risk and reduced the value of the experience into purely
          scientific metrics. In this respect, it&#39;s easy to see why many
          mothers opt for natural births, even with the associated risks.
        </p>
      </section>
      <section className="pb-6">
        <h5 className="">Natural at what cost?</h5>
        <p className="pb-2">
        ...
        <p className="pb-2">
          ...
          anything I put in my mouth is comes from petrochemicals is sickening,
          on the basis that it isn&#39;t natural. However, after little
          reflection I realised that the alternative (artificial insemination)
          isn&#39;t much of a &#39;natural&#39; alternative and as Levinovitz
          points out, the history of food seems to be built on its unnatural
        ...
        <p className="pb-2">
          ...
          I guess where I would draw my arbitrary line is at the point where my
          pursuit for what
        </p>
      </section>
      <section className="pb-6">
        <h5 className="">A privilege</h5>
        <p className="pb-2">
          ...
          &#39;unnatural&#39; neo-natal and maternal care. Levinovitz shares a
          story about when he spent time with the people of Huacaria, a native
          community in the Amazon, who were actively choosing to integrate fewer
          natural practices. An elderly Matsigenka women shared her gratitude
          for running water and another elderly man looked at Levinovitz with
        ...
        <p className="pb-2">
          ...
          that has provided us with the opportunity to have these discussions,
          and serious reflections on our personal relationship with nature."
        </p>
      </section>
      <p className="pb-2">Anyway, it&#39;s a cool book, highly recommend.</p>
    </div>
  )
}
